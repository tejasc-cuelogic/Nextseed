...
public class Login
{
	...
	@FindBy (xpath="//SPAN[text()='Choose file'][text()='Choose file'])[2])")
	public WebElement Upload2;
	
	@FindBy (xpath="(//SPAN[text()='Choose file'][text()='Choose file'])[3]")
	public WebElement Upload3;
		
	
	@FindBy (xpath="(//BUTTON[@data-cy='formation-doc'][text()='Continue']")
